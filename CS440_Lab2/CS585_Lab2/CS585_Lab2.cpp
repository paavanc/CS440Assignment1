...
/**
	CS440_P1.cpp
	@author: Paavan Chopra
	@version: 1
 
 Team memebers:  Tim Mock, Anthony Lin, Dan Pereira
 ...
 This program counts the number of fingers on a persons hand.
	--------------
 We used code and formulas from these sites:
 http://stackoverflow.com/questions/22163613/error-with-working-cvconvexitydefect?answertab=votes#tab-top
 -got convex defects from this site
 -threshold ideas from this site
 https://github.com/simena86/handDetectionCV/blob/master/VS2013%20Version/HandDetection/handGesture.cpp
 -got the angle and distance methods from this site
 http://opencv.org/
 -got convex and thresholding from this site
 -used labecode for skin detection, max, and min
